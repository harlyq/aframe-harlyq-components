  ...
  AFRAME.registerComponent("mesh-particles", {
    ...
    spawn() {
      ...
      const newParticle = {
        ...
        // @ts-ignore
        rotations: this.overTimes["rotation"].map(part => randomize(part, random).map(deg => degToRad(deg))),
        scales: this.overTimes["scale"].map(part => randomize(part, random)),
        colors: this.overTimes["color"].map(part => randomize(part, random)),
        ...
        velocities: this.overTimes["velocity"].map(part => randomize(part, random)),
        accelerations: this.overTimes["acceleration"].map(part => randomize(part, random)),
        radialVelocities: this.overTimes["radialVelocity"].map(part => randomize(part, random)),
        radialAccelerations: this.overTimes["radialAcceleration"].map(part => randomize(part, random)),
        angularVelocities: this.overTimes["angularVelocity"].map(part => randomize(part, random)),
        angularAccelerations: this.overTimes["angularAcceleration"].map(part => randomize(part, random)),
        orbitalVelocities: this.overTimes["orbitalVelocity"].map(part => randomize(part, random)),
        orbitalAccelerations: this.overTimes["orbitalAcceleration"].map(part => randomize(part, random)),
